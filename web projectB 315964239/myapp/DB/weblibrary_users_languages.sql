...
CREATE TABLE `users_languages` (
  ...
  PRIMARY KEY (`user_email`,`user_language`),
  KEY `language_idx` (`user_language`),
  CONSTRAINT `fk_user_email_language` FOREIGN KEY (`user_email`) REFERENCES `users` (`email`),
  CONSTRAINT `fk_user_language` FOREIGN KEY (`user_language`) REFERENCES `languages` (`language`)
