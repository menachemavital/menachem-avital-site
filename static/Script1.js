...
new Book("ענבי זעם", "ג'ון סטיינבק", "avimen@post.bgu.ac.il", "../static/images/book covers/rage grapes.jpeg","זמין", "אחלה ספר");
new Book("קדמת עדן", "ג'ון סטיינבק", "avimen@post.bgu.ac.il", "../static/images/book covers/east of eden.jpeg", "זמין", "אחלה ספר");
new Book("ל עכברים ואנשים", "ג'ון סטיינבק", "avimen@post.bgu.ac.il", "../static/images/book covers/of mice and people.jpeg", "זמין", "אחלה ספר");
